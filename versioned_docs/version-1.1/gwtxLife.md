...
The layer 2 sUDT backend provides [ERC20](https://eips.ethereum.org/EIPS/eip-20) compatible interface. You may not using Solidity and EVM, but a similar API is available for you to use.
