...
The following release notes cover the most recent and major changes in Godwoken v1.2. You can also see all release notes in the [Godwoken Changlog](https://github.com/godwokenrises/godwoken/blob/develop/CHANGELOG.md). 
...
- Refresh readonly mem-pool when receives new mem-block. [#721](https://github.com/godwokenrises/godwoken/pull/721)
...
- Fixed the rejection of transactions that have less gas than intrinsic gas，and added intrinsic gas check feature to Godwoken. [#725](https://github.com/godwokenrises/godwoken/pull/725)

- Support packaging failed transactions into layer2 block. [#684](https://github.com/godwokenrises/godwoken/pull/684)
...
- Support upgrade backend executable binaries. [#713](https://github.com/godwokenrises/godwoken/pull/713)
...
- Support for the new options in the config file: `max_txs`, `max_deposits` and `max_withdrawals`. These options regulate the max number of each items in a block. [#714](https://github.com/godwokenrises/godwoken/pull/714)

- Added the return of committed info on the withdrawal query RPC. [#706](https://github.com/godwokenrises/godwoken/pull/706)
