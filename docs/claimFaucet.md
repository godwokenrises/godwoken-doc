...
1. Open [Godwoken Bridge](https://testnet.bridge.godwoken.io/)
...
If you’re new to Godwoken, it’s normal that your `L1 Balance` and `L1 Balance` are both `0`. You can follow the tutorials below to claim free assets to your layer1/layer2 accounts. 
...
On the CKB layer1 testnet, you can claim CKB using the Nervos Aggron Faucet, a official faucet site provided by Nervos. On Nervos Aggron Faucet, each layer1 address can claim 10,000 CKB once every 24 hours.

Follow these steps to claim CKB to your layer1 account:

1. Copy your `L1 Wallet Address` on [Godwoken Bridge](https://testnet.bridge.godwoken.io/)
2. Open [Nervos Aggron Faucet](https://faucet.nervos.org/)
...
:::tip
For more info, Nervos Aggron Faucet accepts all kinds of valid CKB address, so you can actually claim pCKB for your layer2 account using Nervos Aggron Faucet. For this part of tutorial, please visit this part of content: [Claim pCKB](#claim-pckb).
:::
...
1. Open and connect to [Godwoken Bridge](https://testnet.bridge.godwoken.io/)
...
The first method is if you only need a small amount of pCKB, you can visit [Test pCKB Faucet](https://faucet.godwoken.com/), and then click the “request 10 pCKB from faucet” button to claim 10 pCKB to your layer2 account, on the way it will ask you to connect to your wallet, you should just follow the instructions and the whole process will complete soon.

However, if you want to claim a large amount of pCKB, the second method is more recommended: [Nervos Aggron Faucet](https://faucet.nervos.org/). 

Nervos Aggron Faucet is an official faucet site provided by Nervos. On Nervos Aggron Faucet, each layer1 address can claim 10,000 CKB once every 24 hours. The site only provides CKB, but you can claim funds using your `L1 Deposit Address`, so it's like Nervos Aggron Faucet depositing capacity to your layer2 account. 

You can follow the below steps to try it out:

1. Copy your `L1 Deposit Address` on [Godwoken Bridge](https://testnet.bridge.godwoken.io/)
2. Open [Nervos Aggron Faucet](https://faucet.nervos.org/)
3. Paste `L1 Deposit Address` in the page input
4. Click “Claim” button next to the page input to claim

After all above steps are completed, Godwoken will find the CKB cell that Nervos Aggron Faucet just sent you, and convert it into your layer2 capacity. So in conclusion, every CKB cell Nervos Aggron Faucet transfers to your `L1 Deposit Address` is a deposit cell. 

How Godwoken deposit works with Nervos Aggron Faucet:
...
1. Copy your `Ethereum Address` on [Godwoken Bridge](https://testnet.bridge.godwoken.io/)
...
When the above process is complete, you should be able to see the bridged assets on Godwoken Bridge. Now you can deposit the bridged assets from CKB layer1 to Godwoken layer2, by following the below steps:

1. Open the deposit page of [Godwoken Bridge](https://testnet.bridge.godwoken.io/)
...
If you are tired of claiming faucet on Nervos Pudge Faucet every day, or if you have a lot of accounts that nees to claim faucet, maybe you should try out Account-Faucet, a command-line tool that can help you claim CKB on layer1/layer2, but easier.

For detailed instructions, please visit: Account-Faucet [Account-Faucet](account-faucet.md).
